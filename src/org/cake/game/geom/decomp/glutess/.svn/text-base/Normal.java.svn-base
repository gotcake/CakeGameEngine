...
class Normal {
    ...
    static float S_UNIT_X;    /* Pre-normalized */
    static float S_UNIT_Y;
 ...
 * coordinate axes).
 */
            S_UNIT_X = (float)0.50941539564955385;    /* Pre-normalized */
            S_UNIT_Y = (float)0.86052074622010633;
        } else {
            S_UNIT_X = 1.0f;
            S_UNIT_Y = 0.0f;
        }
    ...
    static void ComputeNormal(GLUtessellatorImpl tess, float[] norm) {
        GLUvertex v, v1, v2;
