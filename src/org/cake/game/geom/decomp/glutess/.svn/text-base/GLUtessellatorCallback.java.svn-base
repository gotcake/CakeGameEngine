...
public interface GLUtessellatorCallback {
   ...
   * float, an array of four references, an array of four elements each of
   ...
   * </UL>
   * <PRE>
   *         void myCombine(float[] coords, Object[] data,
   ...
   * @see #combine combine
   */
  public void combineData(float[] coords, Object[] data,
                          float[] weight, Object[] outData,
                          Object polygonData);
