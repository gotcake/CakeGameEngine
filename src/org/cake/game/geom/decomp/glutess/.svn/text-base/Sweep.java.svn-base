 ...
 */ {
        float t1 = Geom.VertL1dist(org, isect);
        float t2 = Geom.VertL1dist(dst, isect);
 ...
 */
    private static final float SENTINEL_COORD = (4.f * Constants.MAX_TESS_COORD);

    static void AddSentinel(GLUtessellatorImpl tess, float t)
/*
