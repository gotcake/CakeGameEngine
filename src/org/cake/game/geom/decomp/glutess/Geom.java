...
class Geom {
     ...
     */
    static float EdgeEval(GLUvertex u, GLUvertex v, GLUvertex w) {
        float gapL, gapR;
    ...
    static float EdgeSign(GLUvertex u, GLUvertex v, GLUvertex w) {
        float gapL, gapR;
    ...
    static float TransEval(GLUvertex u, GLUvertex v, GLUvertex w) {
    ...
    static float TransSign(GLUvertex u, GLUvertex v, GLUvertex w) {
...
/* Versions of VertLeq, EdgeSign, EdgeEval with s and t transposed. */
    ...
    static float VertL1dist(GLUvertex u, GLUvertex v) {
    ...
    static float EdgeCos(GLUvertex o, GLUvertex v1, GLUvertex v2) {
        float ov1s = v1.s - o.s;
        float ov1t = v1.t - o.t;
        float ov2s = v2.s - o.s;
        float ov2t = v2.t - o.t;
        float dotp = ov1s * ov2s + ov1t * ov2t;
        float len = (float)(Math.sqrt(ov1s * ov1s + ov1t * ov1t) * Math.sqrt(ov2s * ov2s + ov2t * ov2t));
        if (len > 0.0) {
            dotp /= len;
        }
        return dotp;
    ...
    static final float ONE_MINUS_EPSILON = 1.0f - EPSILON;
}
