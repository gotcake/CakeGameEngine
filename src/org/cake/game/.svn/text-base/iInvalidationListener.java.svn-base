...
/**
 * An interface that listens for screen invalidation. Listeners should reload screen resources when called.
 * @author Aaron Cake
 */
public interface iInvalidationListener {

    /**
     * An indication to reload screen resources.
     * @param g the Game
     */
    public void invalidated(Game g);

    /**
     * Called after all invalidation had been completed.
     * @param g
     */
