...
/**
 * A particle emitter that remains stationary while emitting particles in a normal fashion.
 * @author Aaron Cake
 */
public class StaticParticleEmitter extends AbstractParticleEmitter {
