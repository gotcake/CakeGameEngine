 ...
 * @author Aaron Cake
 */
public class FitViewportMetrics implements iViewportMetrics {

    private float width, height;
    private int curw, curh, offx, offy, ah, aw;
    private boolean needsLaidOut;
    private Transform2 transform, transforminvert;

    public FitViewportMetrics(float width, float height) {
