...
import org.cake.game.particle.DynamicImageParticleEmitter;
 ...
 * @author Aaron
 */
public class DynamicImageEmitterPanel extends javax.swing.JPanel implements iEmitterConfigurator {
     ...
     */
    public DynamicImageEmitterPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        emitterVelXSpinner = new javax.swing.JSpinner();
        jLabel5 = new javax.swing.JLabel();
        emitterVelYSpinner = new javax.swing.JSpinner();
        ...
        deathModeComboBox = new javax.swing.JComboBox();
        ...
        emitterLifeSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(3000.0f), Float.valueOf(0.0f), null, Float.valueOf(10.0f)));
        ...
        emitterSettingsLabel.setText("Dynamic Emitter Settings:");
        ...
        lifeLowSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(750.0f), Float.valueOf(0.0f), Float.valueOf(20000.0f), Float.valueOf(100.0f)));
        ...
        lifeHighSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(1000.0f), Float.valueOf(0.0f), Float.valueOf(20000.0f), Float.valueOf(100.0f)));
        ...
        emitterStartXSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(-100.0f), null, null, Float.valueOf(1.0f)));
        ...
        jLabel3.setText("Start Velocity X:");

        emitterVelXSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(100.0f), null, null, Float.valueOf(1.0f)));
        emitterVelXSpinner.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                emitterVelXSpinnerStateChanged(evt);
            }
        });

        jLabel5.setText("Y:");

        emitterVelYSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(-150.0f), null, null, Float.valueOf(1.0f)));
        emitterVelYSpinner.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                emitterVelYSpinnerStateChanged(evt);
            }
        });
        ...
        jLabel6.setText("Death Mode:");

        deathModeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fizzle Out", "Fade Out" }));
        deathModeComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deathModeComboBoxActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(gradientHousingPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(emitterVelXSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(jLabel5)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(emitterVelYSpinner))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jLabel6)
                                    .addGap(18, 18, 18)
                                    .addComponent(deathModeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(64, 64, 64)))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(emitterVelXSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5)
                    .addComponent(emitterVelYSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(deathModeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(colorsLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void blendModeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_blendModeComboBoxActionPerformed
       ...
       emitter.setBlendingMode(BlendingMode.valueOf(s));
    ...
    private void emitterStartXSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_emitterStartXSpinnerStateChanged
        emitter.setEmitterStartPos((float)emitterStartXSpinner.getValue(), emitter.getEmitterStartPosY());
    ...
    private void emitterStartYSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_emitterStartYSpinnerStateChanged
        emitter.setEmitterStartPos(emitter.getEmitterStartPosX(), (float)emitterStartYSpinner.getValue());
    }//GEN-LAST:event_emitterStartYSpinnerStateChanged

    private void emitterVelXSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_emitterVelXSpinnerStateChanged
        emitter.setEmitterStartVelocity((float)emitterVelXSpinner.getValue(), emitter.getEmitterStartVelocityY());
    }//GEN-LAST:event_emitterVelXSpinnerStateChanged

    private void emitterVelYSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_emitterVelYSpinnerStateChanged
        emitter.setEmitterStartVelocity(emitter.getEmitterStartVelocityX(), (float)emitterVelYSpinner.getValue());
    }//GEN-LAST:event_emitterVelYSpinnerStateChanged
    ...
    private void deathModeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deathModeComboBoxActionPerformed
        emitter.setFadeMode(deathModeComboBox.getSelectedIndex() + 1);
    }//GEN-LAST:event_deathModeComboBoxActionPerformed
    ...
    private javax.swing.JComboBox deathModeComboBox;
    ...
    private javax.swing.JSpinner emitterVelXSpinner;
    private javax.swing.JSpinner emitterVelYSpinner;
    ...
    private DynamicImageParticleEmitter emitter;
    ...
    public void init(final ParticleDisplay pd) {
        game = pd;
        emitter = new DynamicImageParticleEmitter();
    ...
    private void initEmitter() {
        ...
        emitter.setEmitterDelay((float)delaySpinner.getValue()/1000);
        emitter.setEmitterLife((float)emitterLifeSpinner.getValue()/1000);
        emitter.setEmitterStartPos(
                (float)emitterStartXSpinner.getValue(),
                (float)emitterStartYSpinner.getValue()
                );
        emitter.setEmitterStartVelocity(
                (float)emitterVelXSpinner.getValue(),
                (float)emitterVelYSpinner.getValue()
                );
